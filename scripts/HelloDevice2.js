...
var requestObject = {
  ...
  "method": "PUT", // the method is optional, it defaults to GET
   "files": {test:file, 
            body:file2}
}
...
return scriptResponse;//First, we'll require the 'http' library to use later for calling a 3rd party webservice
var http = require("http");  
